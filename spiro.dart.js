...
$$.Rect = {"": "Object;left,top,width,height",
  ...
  $eq: function(_, other) {
    ...
    if (t1 == null ? t2 == null : t1 === t2) {
      ...
      t2 = other.top;
      if (t1 == null ? t2 == null : t1 === t2)
        if ($.$eq(this.width, other.width) === true) {
          t1 = this.height;
          t2 = other.height;
...
$$._PostMessageScheduler = {"": "_MicrotaskScheduler;_MICROTASK_MESSAGE,_nextMicrotaskFrameScheduled,_liblib1$_callback",
  ...
  _PostMessageScheduler$1: function(callback) {
    $.Window_methods.get$onMessage($.window()).listen$1(this.get$_handleMessage());
  }
};
...
$$._SetImmediateScheduler = {"": "_MicrotaskScheduler;_nextMicrotaskFrameScheduled,_liblib1$_callback",
  _schedule$0: function() {
    $.Window_methods._setImmediate$1(window, this.get$_handleImmediate());
  },
      ...
      default:
        ...
        if (state0 === 3 || state0 === 2 || state0 === 1 || state0 === 0 && typeof e === "object" && e !== null && (e.constructor === Array || !!$.getInterceptor(e).$isList))
          switch (state0) {
            ...
            case 3:
              state0 = 0;
              for (t2 = $.getInterceptor$ax(copy); i < $length; ++i)
...
$$.Spirograph = {"": "Object;num_wheels,wheels_1,wheels_2,wheels_interpolate,canvas>,_width@,_height?,renderTime,slew,slew_increasing",
  ...
  Spirograph$1: function(canvas) {
    var t1, t2, t3, i;
    for (t1 = this.wheels_1, t2 = this.wheels_2, t3 = this.wheels_interpolate, i = 0; i < this.num_wheels; ++i) {
      t1.push($.Wheel$());
      t2.push($.Wheel$());
      t3.push($.Wheel$());
      this.randomize$1(t1);
    ...
    $.Window_methods.setImmediate$1($.window(), new $.anon(this));
  }
};
...
$$.anon = {"": "Closure;this_0",
  call$0: function() {
    ...
    $.set$width$x(t2.get$canvas(t1), t1.get$_width());
  }
};
...
$$.IFrameElement = {"": "Element;width}"};

$$.ImageElement = {"": "Element;width},x=,y="};

$$.InputElement = {"": "Element;width}"};
